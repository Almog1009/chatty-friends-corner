...
const AppSidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          // Mobile: off-canvas, Desktop: fixed
          "fixed left-0 top-0 z-40 h-screen transition-all duration-300 ease-in-out bg-white border-r border-theme-purple/20",
          isOpen ? "translate-x-0" : "-translate-x-full",
          "w-64 md:w-64 md:translate-x-0", // Always visible on md+
          "md:static md:left-0 md:top-0"
        )}
      >
        <div className="h-full flex flex-col overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-theme-purple/20">
            ...
            <Button
              ...
              className="hover:bg-theme-purple/10 md:hidden"
            >
